  ...
  return (
    ...
    >
      ...
      <g id="before-side">
        ...
        <g id="email-list">
          {/* Email 1 - Unread */}
          <rect x="20" y="80" width="560" height="65" fill="#FEF3C7" stroke="#FCD34D" strokeWidth="1" />
          ...
          {/* Email 2 - Unread */}
          <rect x="20" y="150" width="560" height="65" fill="#FEF3C7" stroke="#FCD34D" strokeWidth="1" />
          ...
          {/* Email 3 - Unread */}
          <rect x="20" y="220" width="560" height="65" fill="#FEF3C7" stroke="#FCD34D" strokeWidth="1" />
          ...
          {/* Email 4 */}
          <rect x="20" y="290" width="560" height="65" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1" />
          ...
          {/* Email 5 */}
          <rect x="20" y="360" width="560" height="65" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1" />
          ...
          <rect x="20" y="430" width="560" height="65" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1" />
          ...
          <rect x="20" y="500" width="560" height="65" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1" />
      ...
      <g id="after-side">
        ...
        <rect x="650" y="90" width="500" height="460" fill="#ffffff" stroke="#E5E7EB" strokeWidth="1" rx="8" />
