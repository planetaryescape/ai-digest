        ...
        <div className="container mx-auto px-4 pt-20 pb-16 md:pt-28 md:pb-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-600 sm:text-xl">
              Stop drowning in 50+ AI newsletters. Get intelligent summaries with role-specific
              insights and product opportunities delivered to your inbox every Sunday.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">Set it up once, save hours every week</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    GPT-4 reads every newsletter, fact-checks with web search, and identifies what
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Beautiful email with summaries, role-specific advice, and product opportunities.
                    Read in 10 minutes.
                  </p>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  GPT-4 doesn&apos;t just summarize – it identifies trends, validates claims, and
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  Get actionable advice tailored to your role – developer, founder, product manager,
                  or investor.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  Discover specific features and products you could build based on emerging AI
                  trends.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  Hard limits on API usage. Never worry about runaway costs. Typically $0.10 per
                  digest.
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      The week&apos;s most important AI developments in 3 paragraphs
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      10-15 must-read pieces with smart summaries
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      Actionable tips for your specific job function
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      3-5 opportunities you could build this week
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 p-4 bg-white/70 rounded-lg">
                <p className="text-sm text-gray-600 italic">
                  &ldquo;AI Digest turned my newsletter anxiety into excitement. I actually look
                  forward to Sundays now.&rdquo;
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">Start free. Upgrade when you see the value.</p>
            </div>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">
                  We use OAuth 2.0 for secure authentication. We can only read emails, not send or
                  delete them. Your credentials are never stored, and you can revoke access anytime
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We intelligently identify and process AI, tech, and innovation newsletters. This
                  includes publications like The Neuron, TLDR, Benedict Evans, Stratechery, and 100+
                  others. Non-tech emails are ignored.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Currently, digests are sent every Sunday at 8 AM. Custom schedules (daily,
                  bi-weekly) are coming soon based on user feedback.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Try it free for a week. If you&apos;re not saving hours and feeling more informed,
                  simply don&apos;t subscribe. No tricks, no hassle.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Those tools just organize emails. We actually read, analyze, and synthesize
                  content using GPT-4. You get insights and recommendations, not just a list of
                  links.
                </p>
              </div>
            </div>
