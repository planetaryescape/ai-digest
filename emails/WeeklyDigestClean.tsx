          ...
          <Container style={{
              ...
              <Section style={{ marginBottom: "32px" }}>
                ...
                {digest.whatHappened.map((item, i) => (
                  <div key={i} style={{
                    marginBottom: "16px",
                    paddingBottom: "16px",
                    borderBottom: i < digest.whatHappened.length - 1 ? "1px solid #e5e5e5" : "none",
                  }}>
                    <Text style={{
                      fontSize: "16px",
                      fontWeight: "600",
                ...
                {digest.takeaways.map((takeaway, i) => (
                  <div key={i} style={{
                    ...
                    borderLeft: `3px solid ${
                      takeaway.category === "technical" ? "#0066cc" :
                      takeaway.category === "business" ? "#28a745" :
                      "#dc3545"
                    }`,
                  }}>
                    <Text style={{
                      fontSize: "11px",
                      fontWeight: "600",
                      color: takeaway.category === "technical" ? "#0066cc" :
                             takeaway.category === "business" ? "#28a745" :
                             "#dc3545",
                      margin: "0 0 4px 0",
                      textTransform: "uppercase",
                    ...
                    <div style={{
                      ...
                      <div style={{ display: "flex", gap: "8px" }}>
                        <span style={{
                          fontSize: "11px",
                          padding: "2px 6px",
                          backgroundColor: play.effort === "quick-win" ? "#d4edda" :
                                         play.effort === "1-2-days" ? "#fff3cd" :
                                         "#f8d7da",
                          color: play.effort === "quick-win" ? "#155724" :
                                play.effort === "1-2-days" ? "#856404" :
                                "#721c24",
                          borderRadius: "3px",
                        }}>
                          {play.effort}
                        ...
                        <span style={{
                          fontSize: "11px",
                          padding: "2px 6px",
                          backgroundColor: play.impact === "high" ? "#d1ecf1" :
                                         play.impact === "medium" ? "#f8f9fa" :
                                         "#e2e3e5",
                          color: play.impact === "high" ? "#0c5460" :
                                play.impact === "medium" ? "#383d41" :
                                "#383d41",
                          borderRadius: "3px",
                        }}>
                          {play.impact}
                  ...
                  <div style={{
                    ...
                    {summary.items.map((item, i) => (
                      <div key={i} style={{
                        ...
                        {item.gmailLink ? (
                          <Link href={item.gmailLink} style={{
                            color: "#666",
                            textDecoration: "none",
                          }}>
                            {item.subject}
            ...
            <Section style={{ textAlign: "center" }}>
              <Text style={{
                ...
                <br />
                <Link href="mailto:digest@bhekani.com" style={{
                  color: "#666",
                  textDecoration: "none",
                }}>
                  Contact
                ...
                {" • "}
                <Link href="https://bhekani.com" style={{
                  color: "#666",
                  textDecoration: "none",
                }}>
                  Blog
